...
import com.wolygo.taxi.rider.adapter.LanguageAdapter;
import com.wolygo.taxi.rider.model.LanguagePojo;
...
public class FragmentLanguage extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        apply.setTypeface(AppConst.font_quicksand_medium(context));
