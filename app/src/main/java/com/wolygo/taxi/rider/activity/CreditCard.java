...
public class CreditCard extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //        txtDes.setTypeface(AppConst.font_quicksand_medium(getApplicationContext()));
        //        btnPay.setTypeface(AppConst.font_quicksand_medium(getApplicationContext()));
        ...
        cardForm.setOnCardFormSubmitListener(new OnCardFormSubmitListener() {
            ...
            public void onCardFormSubmit() {
                M.showLoadingDialog(CreditCard.this);
                new PayRide().execute();
                Toast.makeText(CreditCard.this, "Name : "+cardForm.getCardholderName()+" | Last 4 digits : "+cardForm.getCardNumber(), Toast.LENGTH_SHORT).show();
