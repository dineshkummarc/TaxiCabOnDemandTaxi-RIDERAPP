...
//            relative_layout = (RelativeLayout) view.findViewById(R.id.relative_layout);
            ...
            delete.setTypeface(AppConst.font_quicksand_medium(context));
            fav_name.setTypeface(AppConst.font_quicksand_medium(context));
...
//            String url = AppConst.Server_url+"delete_favorite_ride.php";
            String url = AppConst.Server_url+"favoriterides/delete";
