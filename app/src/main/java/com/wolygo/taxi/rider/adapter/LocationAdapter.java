...
public class LocationAdapter extends RecyclerView.Adapter<LocationAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder  implements View.OnClickListener {
        ...
        public MyViewHolder(View view) {
            ...
            nom_vehicule.setTypeface(AppConst.font_quicksand_medium(context));
            statut_location.setTypeface(AppConst.font_quicksand_medium(context));
            prix_total.setTypeface(AppConst.font_quicksand_medium(context));
            date.setTypeface(AppConst.font_quicksand_medium(context));
            moreOptions.setTypeface(AppConst.font_quicksand_medium(context));
            cancel.setTypeface(AppConst.font_quicksand_medium(context));
...
//        Glide.with(context).load(AppConst.Server_urlMain+"assets/images/type_vehicle_rental/"+locationPojo.getImage())
        Glide.with(context).load(AppConst.Server_urlMain+locationPojo.getImage())
...
//            String url = global_url+"canceled_location.php";
            String url = global_url+"vehiclerents/cancel";
