...
//            String url = global_url+"set_location.php";
            String url = global_url+"vehiclerents/register";
            StringRequest jsonObjReq = new StringRequest(Request.Method.POST,
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(context, context.getResources().getString(R.string.echec_denvoi)+error.toString(), Toast.LENGTH_SHORT).show();
                    M.hideLoadingDialog();
                }
            }) {
...
//                    Log.i("nb_jour", nb_jour);
//                    Log.i("date_debut", date_debut);
//                    Log.i("date_fin", date_fin);
//                    Log.i("contact", contact);
//                    Log.i("id_user_app", M.getID(context));
//                    Log.i("id_vehicule", String.valueOf(id_vehicule));
//                    Log.i("user_id", "1");
