...
//            relative_layout = (LinearLayout) view.findViewById(R.id.relative_layout);
            ...
            duree_requete.setTypeface(AppConst.font_quicksand_medium(mContext));
            name_vehicule.setTypeface(AppConst.font_quicksand_medium(mContext));
...
//        Glide.with(mContext).load(AppConst.Server_urlMain+"assets/images/type_vehicle/"+ categoryVehiclePojo.getImage())
        Glide.with(mContext).load(AppConst.Server_urlMain+categoryVehiclePojo.getImage())
