package com.wolygo.taxi.rider.fragment;
...
public class FragmentProfile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        input_nom.setTypeface(AppConst.font_quicksand_medium(context));
        input_prenom.setTypeface(AppConst.font_quicksand_medium(context));
        input_phone.setTypeface(AppConst.font_quicksand_medium(context));
        input_mail.setTypeface(AppConst.font_quicksand_medium(context));
        input_mdp.setTypeface(AppConst.font_quicksand_medium(context));
        input_brand.setTypeface(AppConst.font_quicksand_medium(context));
        input_color.setTypeface(AppConst.font_quicksand_medium(context));
        input_model.setTypeface(AppConst.font_quicksand_medium(context));
        input_numberplate.setTypeface(AppConst.font_quicksand_medium(context));

        input_nom.setText((M.getNom(context).equals("null"))? "" : M.getNom(context));
        input_prenom.setText(M.getPrenom(context));
        input_phone.setText(M.getPhone(context));
        input_mail.setText(M.getEmail(context).equals("null")? "" : M.getEmail(context));
...
//        progressBar.setVisibility(View.VISIBLE);
        if(!M.getPhoto(context).equals("") && !M.getPhoto(context).equals("null")) {
...
//        Toast.makeText(mContext, ""+getFileName(filePath), Toast.LENGTH_SHORT).show();
        ...
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data) {
            ...
            bitmap = getResizeImage(bitmap,320,true);
...
//            String url = AppConst.Server_url+"set_user_photo.php";
            String url = AppConst.Server_url+"customers/update/photo";
...
//                                    Toast.makeText(context, "Ok", Toast.LENGTH_SHORT).show();
                                    if(!msg.getString("image").equals("")) {
                                        M.setPhoto(msg.getString("image_name"), context);
                                        // loading model cover using Glide library
                                        Glide.with(context).load(AppConst.Server_urlMain + "images/app_user/" + msg.getString("image_name"))
                                                .skipMemoryCache(false)
                                                .listener(new RequestListener<Drawable>() {
                                                    @Override
                                                    public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
...
//            String url = AppConst.Server_url+"set_user_nom.php";
            String url = AppConst.Server_url+"customers/update/nom";
...
//            String url = AppConst.Server_url+"set_user_prenom.php";
            String url = AppConst.Server_url+"customers/update/prenom";
...
//            String url = AppConst.Server_url+"set_user_phone.php";
            String url = AppConst.Server_url+"customers/update/phone";
...
//            String url = AppConst.Server_url+"set_user_email.php";
            String url = AppConst.Server_url+"customers/update/email";
...
//            String url = AppConst.Server_url+"set_user_mdp.php";
            String url = AppConst.Server_url+"customers/update/password";
