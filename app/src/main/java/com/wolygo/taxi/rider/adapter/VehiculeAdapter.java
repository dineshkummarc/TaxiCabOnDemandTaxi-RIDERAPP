...
import com.wolygo.taxi.rider.fragment.customer.BottomSheetFragmentLocation;
import com.wolygo.taxi.rider.model.M;
import com.wolygo.taxi.rider.model.VehiculePojo;
...
public class VehiculeAdapter extends RecyclerView.Adapter<VehiculeAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder  implements View.OnClickListener {
        ...
        public MyViewHolder(View view) {
            ...
            nom_vehicule.setTypeface(AppConst.font_quicksand_medium(mContext));
            status_vehicule.setTypeface(AppConst.font_quicksand_medium(mContext));
            prix_vehicule.setTypeface(AppConst.font_quicksand_medium(mContext));
            nb_place_vehicule.setTypeface(AppConst.font_quicksand_medium(mContext));
            moreOptions.setTypeface(AppConst.font_quicksand_medium(mContext));
            book_now.setTypeface(AppConst.font_quicksand_medium(mContext));
...
//        Glide.with(mContext).load(AppConst.Server_urlMain+"assets/images/type_vehicle_rental/"+vehiculePojo.getImage())
        Glide.with(mContext).load(AppConst.Server_urlMain+vehiculePojo.getImage())
