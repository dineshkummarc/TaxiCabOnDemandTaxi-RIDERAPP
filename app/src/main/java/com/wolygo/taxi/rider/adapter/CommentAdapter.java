...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder  implements View.OnClickListener {
        ...
        public MyViewHolder(View view) {
            ...
            comment.setTypeface(AppConst.font_quicksand_medium(mContext));
...
//            CoursePojo coursePojo = albumList.get(getAdapterPosition());
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if(!commentPojo.getCustomer_photo().equals("")) {
            ...
            Glide.with(mContext).load(AppConst.Server_urlMain + "images/app_user/" + commentPojo.getCustomer_photo())
