...
import com.wolygo.taxi.rider.model.User;
...
public class SubscribeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setTypeface(AppConst.font_quicksand_medium(context));
        phone_subs.setTypeface(AppConst.font_quicksand_medium(context));
        password_subs.setTypeface(AppConst.font_quicksand_medium(context));
        password_conf.setTypeface(AppConst.font_quicksand_medium(context));
        firstname_subs.setTypeface(AppConst.font_quicksand_medium(context));
        email_insc.setTypeface(AppConst.font_quicksand_medium(context));
...
//            String url = global_url+"user_register.php";
            String url = global_url+"customers/register";
