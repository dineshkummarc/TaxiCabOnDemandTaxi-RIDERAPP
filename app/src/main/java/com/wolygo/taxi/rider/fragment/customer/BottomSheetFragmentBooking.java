...
import com.wolygo.taxi.rider.adapter.CategoryVehicleAdapter;
import com.wolygo.taxi.rider.controller.AppController;
import com.wolygo.taxi.rider.directionhelpers.FetchURL;
import com.wolygo.taxi.rider.model.CategoryVehiclePojo;
...
//            String url = AppConst.Server_url+"set_favorite_ride.php";
            String url = AppConst.Server_url+"favoriterides/register";
...
//            String url = AppConst.Server_url+"get_categorie_vehicle.php";
            String url = AppConst.Server_url+"vehicletypes";
            StringRequest jsonObjReq = new StringRequest(Request.Method.POST,
                    url,
                    new Response.Listener<String>() {
