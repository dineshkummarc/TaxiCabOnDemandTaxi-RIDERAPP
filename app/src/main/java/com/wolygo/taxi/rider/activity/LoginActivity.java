...
public class LoginActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        create_customer_account.setTypeface(AppConst.font_quicksand_medium(context));
        create_driver_account.setTypeface(AppConst.font_quicksand_medium(context));
        input_phone.setTypeface(AppConst.font_quicksand_medium(context));
        password.setTypeface(AppConst.font_quicksand_medium(context));
...
//            String url = global_url+"user_login.php";
            String url = global_url+"customers/login";
